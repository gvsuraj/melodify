    ...
    <>
      ...
      <aside className={`sidebar${open ? " open" : ""}`}>
        ...
        <nav className="sidebar-nav">
          <NavLink to="/" end className={({ isActive }) => isActive ? "nav-item active" : "nav-item"} onClick={close}>
            <svg viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M12 3L4 9v12h5v-7h6v7h5V9z"/></svg>
            Home
          </NavLink>
          <NavLink to="/search" className={({ isActive }) => isActive ? "nav-item active" : "nav-item"} onClick={close}>
          ...
          <NavLink to="/library" className={({ isActive }) => isActive ? "nav-item active" : "nav-item"} onClick={close}>
          ...
          <NavLink to="/playlists" className={({ isActive }) => isActive ? "nav-item active" : "nav-item"} onClick={close}>
          ...
          <NavLink to="/vibe-together" className={({ isActive }) => isActive ? "nav-item active" : "nav-item"} onClick={close}>
        ...
        <div className="sidebar-user">
          ...
          <NavLink to="/settings" className="settings-icon-btn" title="Settings" onClick={close}>
